...
<body class="bg-dots-darker">
    ...
    <style>
        ...
        body{
            background-color: {{ config('app.EMPRESA_BACKGROUND') }};
        }
       
    </style>
    
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm nav_flotante">
            <div class="container">
                ...
                <img class="mini_logo" src="{{ config('app.LOGO_EMPRESA') }}" alt="logo de empresa">
                <span class="navbar-brand titulo_logo">{{ config("app.FRASE_EMPRESA") }}</span>
                <img class="mini_logo" src="{{ config('app.LOGO_EMPRESA') }}" alt="logo de empresa">
                    <!-- Left Side Of Navbar -->
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                     <img src="/summary2/img/online.png" class="mr-2" width="10">{{ Auth::user()->name }} <span class="caret"></span>
                                </a>
        ...
        <main class="py-4" style="padding-top: 71px !important;">
            @yield('content')
        </main>
    </div>
