...
function rsync_command_3() {
    rsync -avz -e 'ssh -p 5427 -i /home/server/.ssh/id_mail_rsa_inprocasa' inprocasa@inprocasa.com:/home/inprocasa/mail/inprocasa.com/dte /home/server/Documents/manejador_correos/mails_inprocasa_dte
}
